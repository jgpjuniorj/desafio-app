...
# Removido o Elastic IP e o NAT Gateway, pois não são necessários
...
# Ajuste na rota para sub-redes privadas sem NAT Gateway
resource "aws_route" "private_internet_access" {
  route_table_id         = aws_route_table.private.id
  destination_cidr_block = "0.0.0.0/0"
  gateway_id             = aws_internet_gateway.main.id # Usando o Internet Gateway para tráfego de saída
}
